...
<nav>
 ...
 <label for="show-menu" class="close"><span class="fa fa-times"></label>
 <ul id="menu">
  <li><a class="{{ Request::route()->getName()==='home' ? 'active' : '' }}" href="{{ route('home') }}">Kezdőoldal</a></li>
  <li><a class="{{ Request::route()->getName()==='contact' ? 'active' : '' }}" href="{{ route('kapcsolat') }}">Kapcsolat</a></li>
  <li><a href="#">Pastel</a></li>
  <li><a href="#">Archive</a></li>
  <li><a href="#">Empty</a></li>
  <li><a href="#">Also Empty</a></li>
